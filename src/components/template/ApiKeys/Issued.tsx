...
const Issued = () => {
  return (
    <div className='bg-white rounded-3xl shadow-lg p-24 flex flex-col items-center'>
      ...
      <div role='separator' className='w-full h-[1px] bg-[#212121]/10 mb-8' />

      <div className='mb-8'>
        <p className='text-center text-[#212121] text-sm mb-4 font-bold'>
      ...
      <div className='mb-8'>
        <p className='text-center text-[#212121]/40 text-sm mb-2'>
